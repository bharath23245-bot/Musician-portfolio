import { Track, BookingRequest, UpcomingEvent, ArtistProfile, BookingStatus } from '../types/index.js';
import { initialArtistProfile, initialTracks, initialEvents, initialBookings } from './initialData.js';
...
export class BackendStore {
  ...
  addTrack(track: Omit<Track, 'id' | 'plays' | 'releaseDate'> & { id?: string; plays?: number; releaseDate?: string }): Track {
